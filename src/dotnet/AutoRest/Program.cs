...
namespace AutoRest
{
    internal class Program
    {
        private static int Main(string[] args)
        {
            ...
            Console.WriteLine("This is an Azure OpenAPI ARM Validator extension to AutoRest.");
            Console.WriteLine("It cannot be used as a standalone tool.");
            Console.WriteLine("Please use AutoRest to use the validator (flag: azure-arm-validator).");
